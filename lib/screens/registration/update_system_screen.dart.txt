...
class UpdateSystemScreen extends StatefulWidget {
  final int? systemId;
  ...
  @override
  State<UpdateSystemScreen> createState() => _UpdateSystemScreenState();
}

class _UpdateSystemScreenState extends State<UpdateSystemScreen> {
