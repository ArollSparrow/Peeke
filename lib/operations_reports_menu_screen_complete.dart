...
class OperationsReportsMenuScreenComplete extends StatefulWidget {
  const OperationsReportsMenuScreenComplete({Key? key}) : super(key: key);

  @override
  State<OperationsReportsMenuScreenComplete> createState() =>
      _OperationsReportsMenuScreenCompleteState();
}

class _OperationsReportsMenuScreenCompleteState
    extends State<OperationsReportsMenuScreenComplete> {
  // Report periods
